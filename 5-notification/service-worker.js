...
self.addEventListener('install', function(event) {
    ...
    event.waitUntil(
        caches.open('static-'+version).then(function(cache) {
            ...
            return cache.addAll([
                '/pwa-ctd16/5-notification/',
                '/pwa-ctd16/5-notification/main.js',
                '/pwa-ctd16/5-notification/assets/styles.css',
                '/pwa-ctd16/5-notification/assets/vendors.js',
                '/pwa-ctd16/5-notification/img/logo.png'
            ]);
        })
    );
});
